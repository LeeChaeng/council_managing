...
<body>
	<div class="container">
                              ...
                              <div class="modal-dialog">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          <form role="form" action="/send_message" class="form-horizontal" enctype="multipart/form-data" method=POST>
                                          <div class="form-group">
                                                  <label class="col-lg-2 control-label" for="email">From</label>
                                                  <div class="col-lg-10">
                                                      <input type="text" class="form-control" value="${loginInfo_email}" name="sender" readonly>
                                                  </div>
                                              </div>
                                              <div class="form-group">
        ...
        <div class="inbox-body">
	        	...
	        	<button class="bton" onclick="mailS_delete()">삭제</button>
	        	...
	        	<table class="table table-inbox table-hover">
	            	<tbody>
	                	<tr>
	                    	...
	                    	<th></th>
	                    	<th style="width:180px;">보내는 사람</th>
	                        <th style="width:500px;">제목</th>
	                        <th></th>
	                        <th class="text-right">받은 시간</th>
	                    </tr>
	                    <c:forEach var="item" items="${m_list}">
	                    	<c:if test="${item.receiver == loginInfo_email && item.receive_del==false}">
	                    	<c:choose>
	                    		<c:when test="${empty item.read_date}">
								...
								<c:otherwise>
	                                ...
	                                <td></td>
									<td onclick="javascript:copy_to_clipboard(`${item.sender}`)">${item.sender}</td>
									<td onclick="location.href=`/message_detail/${item.m_num}`">${item.title}</td>
									<td></td>
