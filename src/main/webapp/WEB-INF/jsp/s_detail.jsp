	...
	<div class="container">
        ...
        <div class="inbox-body" style="border-left:1px solid grey; border-right:1px solid grey;">
			...
			<div class="btn-group btn-group-sm" role="group" style="float:right;">
	          <button type="button" class="btn btn-default" id="box_authenticated1" onclick="location.href='/message_sender_delete/${m_detail.m_num}'">삭제</button>
	          <button type="button" class="btn btn-default" onclick="location.href='/want_council/send'"> 목록 </button>
	        </div>
    	</div>
	</div>
</body>
